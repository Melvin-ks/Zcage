...
<div class="header">
	<div class="container">
        ...
        <div class="form-group">
          <input type="text" class="form-control form-cont" value="Coming Soon" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='Search';}">
        </div>
		...
		<div class="col-md-4 map-left">
			<h3>Introduction</h3>
				<div class="col-md-15 come">
									<p>You can use this system to prove the loan situation of the enterprise without divulging privacy.</p> 
